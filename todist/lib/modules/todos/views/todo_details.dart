...
class TodoDetails extends HookConsumerWidget {
  ...
  static Future<void> show(
    ...
    return showModalBottomSheet(
      ...
      builder: (context) => TodoDetails(todoId: todoId),
    );
  }

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final todoAynsc = ref.watch(todoProvider(todoId));
          ...
          error: (error, stackTrace) => Center(
            child: Column(
              ...
              children: [
                Text(error.toString()),
                TextButton(
                  onPressed: () => ref.invalidate(todoProvider(todoId)),
